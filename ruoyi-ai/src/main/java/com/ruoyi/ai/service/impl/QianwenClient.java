 ...
 */
@Component
public class QianwenClient extends AbstractAiPlatformClient {

    private static final String PLATFORM_CODE = "qianwen";
    private static final String PLATFORM_NAME = "通义千问";
